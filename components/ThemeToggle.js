  ...
  return (
    <div className="relative">
      ...
      {open && (
        <div
          role="menu"
          className="absolute right-0 mt-[0.97rem] w-30 rounded-bl-lg rounded-br-lg border-[0_2px_2px_2px] border-border bg-background shadow-lg z-50 inset-shadow-top"
        >
          {opts.map((o) => (
            <button
              key={o.key}
