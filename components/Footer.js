        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href={`/${locale || 'en'}`} className="hover:text-primary transition-colors">{t('nav.home')}</Link>
              </li>
              <li>
                <Link href={`/${locale || 'en'}/gallery`} className="hover:text-primary transition-colors">{t('nav.gallery')}</Link>
              </li>
              <li>
                <Link href={`/${locale || 'en'}/contact`} className="hover:text-primary transition-colors">{t('nav.contact')}</Link>
              </li>
            </ul>
          </div>
          ...
          {/* Social Links */}
          <div>
            <h4 className="text-lg font-semibold text-white mb-6">{t('footer.followUs')}</h4>
